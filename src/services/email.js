 ...
 *   EMAIL_FROM      -- "Forge-Recon" <support@reconenterprises.net>
...
const DEFAULT_FROM = '"Forge-Recon" <support@reconenterprises.net>';
...
async function sendUserInviteEmail(toEmail, toName, tempPassword) {
  ...
  const htmlBody = [
    ...
    '  <p style="font-size:16px;font-weight:600;margin:0"><strong>Email:</strong> ' + toEmail + '</p>',
    '  <p style="font-size:16px;font-weight:600;margin:4px 0 0"><strong>Password:</strong> ' + tempPassword + '</p>',
    '</div>',
